...
class TestCaseLalla(HttpRunner):
    config = TConfig(
        **{
            ...
            **{
                ...
                "request": {
                    ...
                    "headers": {
                        ...
                        "referer": "https://staging.jinshuju.net/f/hMFfOC",
                        "sec-fetch-dest": "empty",
                        "sec-fetch-mode": "cors",
                        "sec-fetch-site": "same-origin",
                        "user-agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36",
                        "x-csrf-token": "hpLY9JxgqP9kjnjwXPZB2rc+6B0wqT/YCI+Wp6TNDafAFuGllxZFUlmblLr9ozSboZ2Ggwcnb8SUKhrXYulfnA==",
                    },
                    "json": {
                        "extensions": {
                            "persistedQuery": {
                    ...
                    "method": "POST",
                    "url": "https://staging.jinshuju.net/graphql/f/hMFfOC",
                },
