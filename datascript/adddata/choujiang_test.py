...
class TestCaseChoujiang(HttpRunner):
    config = TConfig(
        **{
            "name": "testcase description",
            "variables": {},
            "verify": False,
            "path": "choujiang_test.py",
        }
    )
    ...
    teststeps = [
        TStep(
            **{
                "name": "/f/DIoQKq/wheel_fortune",
                "request": {
                    "cookies": {
                        "Hm_lpvt_47cd03e974df6869353431fe4f4d6b2f": "1592365857",
                        ...
                        "_gd_session": "%3D%3D--b5bf0df2190cbf1a71a5870e84bb3f986026d963",
                        ...
                        "_gd_sid_uat": "IjVlZTk3ZmY2ZDQ5NmNlNzEyZGM3YTU3NSI%3D--ad9032e61147103e9b329e61f7a10019f459618e",
                        ...
                        "country_code": "CN",
                        "csrf_token": "dePFtw0SxCSF/ZvmPTDg6wOXHbkwEzUNq/Zh55QBOB0zZ/zmBmQpibjod6ycZZWqFTRzJwedZRE3U+2XUiVqJg==",
                        "entry_token": "uLOwiaKm",
                        "gd_registered_from": "jsj_success_ad",
                        "gd_ssf": "MTU5MjM2NTgyMQ%3D%3D--de2e693de724537376aca7dfeda748c209cf6f5b",
                        "has_visited_dashboard_in_two_days": "true",
                        "jsj_locale": "zh-CN",
                        "jsj_uid": "d93ef053-e8bf-4c3c-ae93-2bb8257727b9",
                        "last_fill_entry_token": "uLOwiaKm",
                    ...
                    "headers": {
                        ...
                        "if-none-match": 'W/"372d0da5ca5b92fb7c43b32e5267b9c3"',
                    ...
                    "method": "GET",
                    "url": "https://staging.jinshuju.net/f/DIoQKq/wheel_fortune",
                },
